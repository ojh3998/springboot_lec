...
class ApplicationTests {
  ...
  void board_detail_테스트() {
    Assertions.assertEquals("첫 게시글", boardMapper.selectBoardById(1).getTitle());
  }
  
  @Test
  void board_insert_테스트() {
    Assertions.assertEquals(1, boardMapper.insertBoard(BoardDto.builder().build()));
  }
  
  @Test
  void board_update_테스트() {
    Assertions.assertEquals(1, boardMapper.updateBoard(null));
  }
